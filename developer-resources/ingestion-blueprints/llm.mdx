---
title: "LLM Blueprint"
description: "Effortlessly track LLM token usage for usage-based billing with automatic ingestion to Dodo Payments. Works with AI SDK, OpenAI, Anthropic, OpenRouter, Groq, and Google Gemini."
icon: "brain-circuit"
keywords: ["Dodo Payments", "LLM billing", "token tracking", "AI usage", "usage-based billing", "llm blueprint"]
---
...
2. **Navigate to** Usage Billing → Meters
