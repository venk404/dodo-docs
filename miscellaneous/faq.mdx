...
<Accordion title="Q20: Why is my verification taking so long?">
...
<Accordion title="Q21: I submitted my W-8BEN form, but the signature section doesn't work properly. What do I do?">
...
<Accordion title="Q22: I chose the wrong registration type (business vs individual). How can I fix it?">
...
<Accordion title="Q23: My verification was declined due to entity mismatch. What should I do?">
...
<Accordion title="Q24: I reached $100 in earnings. Will my account get verified faster?">
...
<Accordion title="Q48: Do users get notified when their payment fails?">
  A: Yes. Dodo Payments notifies users of payment failures through multiple channels in live mode:
  - Email notifications
  - Webhook events (for your system to handle)
  - Mobile notifications
  - Dashboard notifications
This ensures both you and your customers stay informed about failed transactions.
</Accordion>
