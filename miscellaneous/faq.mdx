...
<Accordion title="Q33: Do I need a PAN or GST to receive payments?">
...
<Accordion title="Q34: I have a Udyam/MSME certificate. Should I submit W-8BEN or W-8BEN-E?">
...
<Accordion title="Q35: If Dodo handles taxes, why do I need to file W-8BEN(-E)?">
...
<Accordion title="Q36: What types of payments can I accept with Dodo Payments?">
...
<Accordion title="Q37: How can I track payment statuses?">
...
<Accordion title="Q38: What should I do if a payment fails?">
...
<Accordion title="Q39: Does the chargeback apply for business even if my business has a no refund policy?">
...
<Accordion title="Q40: Why is payment.status sometimes null?">
...
<Accordion title="Q41: Why is product_cart null even though it's a checkout?">
  A: 
...
<Accordion title="Q42: Why was my real card blocked during testing?">
...
<Accordion title="Q43: My customer completed payment but I didn't receive webhook?">
  A: Checklist:
...
<Accordion title="Q44: Why is my dashboard showing success, but my app didn't update?">
...
<Accordion title="Q45: I'm not seeing UPI as a payment option — why?">
...
<Accordion title="Q46: Does Dodo support UPI for subscriptions?">
...
<Accordion title="Q47: How do I collect billing details without passing them in API?">
...
<Accordion title="Q48: What's the difference between static and dynamic payment links?">
...
<Accordion title="Q49: Will I get two webhook events when someone starts a subscription?">
...
<Accordion title="Q50: What does subscription.cancelled_at mean? Is it a scheduled cancellation?">
...
<Accordion title="Q51: When does a subscription get charged?">
...
<Accordion title="Q52: How do payouts work with Dodo Payments?">
...
<Accordion title="Q53: What is the minimum threshold amount after fees & taxes to process payouts?">
...
<Accordion title="Q66: What alternative documentation can I provide if my country doesn't use SWIFT codes?">
