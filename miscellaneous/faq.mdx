...
<Accordion title="Q9: How do I get live mode access?">
  A: Once your account verification is approved, Live Mode is automatically enabled. You can start integrating in Test Mode while verification is in progress.
</Accordion>
...
<Accordion title="Q11: Do you support e-commerce websites?">
  A: No, we do not support e-commerce websites.
</Accordion>

<Accordion title="Q12: Can I change my registration type from Organization to Individual (or vice versa)?">
  A: Yes. Contact support via Intercom and we'll enable resubmission on your dashboard. Once enabled, go to the verification section, select the correct registration type, and resubmit your documents.
</Accordion>

<Accordion title="Q13: Can I create an account and switch from Individual to Business later?">
  A: Yes. You can create an account as an Individual and switch to a Business account later.
</Accordion>

## Verification, Tax & Compliance

<Accordion title="Q14: Why is my verification taking so long?">
...
<Accordion title="Q15: I chose the wrong registration type (business vs individual). How can I fix it?">
...
<Accordion title="Q16: Can I use a different name (like my parent's) to sign up and get verified?">
...
<Accordion title="Q17: How do I check the reason for verification rejection?">
...
<Accordion title="Q18: Can I create a new business account if my previous one was declined?">
  A: Yes — but only if:
...
<Accordion title="Q19: I've been told my account was previously deboarded. What does this mean?">
...
<Accordion title="Q20: How do I get my payout verification cleared faster?">
  A: To avoid delays:
...
<Accordion title="Q21: I have a GST with a trade name. Is that considered an organization?">
...
<Accordion title="Q22: How does Dodo Payments handle GST for Indian SaaS merchants?">
  A: Dodo Payments automatically calculates and applies **GST** for Indian merchants based on your customer's location.
</Accordion>

<Accordion title="Q23: Does Dodo Payments handle international sales?">
  A: Yes, Dodo Payments supports international sales and manages all associated compliances.
</Accordion>

<Accordion title="Q24: Are address data such as city, state, zipcode fields mandatory? Can I exclude requesting those values from my customer?">
...
<Accordion title="Q25: Do I need to file taxes in the US if I sell there?">
...
<Accordion title="Q26: Do I need a PAN or GST to receive payments? (For Indian Nationals Only)">
...
<Accordion title="Q27: I have a Udyam/MSME certificate. How does this affect my registration?">
...
<Accordion title="Q28: Can I create an account if I am below 18?">
...
<Accordion title="Q29: Why is my ID verification form failing?">
...
<Accordion title="Q30: Is there any tax form I need to submit?">
  A: The only mandatory tax form is the **W-8BEN-E**, and it is required only if you are a registered entity in the UK.
</Accordion>

<Accordion title="Q31: What details are required in the Product Verification Form (PVF)?">
...
<Accordion title="Q32: What happens if my form is rejected?">
...
<Accordion title="Q33: How do I file an appeal?">
...
<Accordion title="Q34: How long does it take for an appeal to be reviewed?">
  A: Appeals typically take more than **48 working hours** to be reviewed.
</Accordion>

<Accordion title="Q35: What happens if my appeal is rejected?">
...
<Accordion title="Q36: It seems my account appears to be suspended, but compliance says everything is fine. What should I do?">
...
<Accordion title="Q37: My verification is On-Hold — what does that mean?">
...
<Accordion title="Q38: What happens to my existing subscriptions and payments if I get deboarded?">
...
<Accordion title="Q39: How can I delete the products/customers that I have created?">
...
<Accordion title="Q40: How can I have a custom UI for the payments page?">
...
<Accordion title="Q41: Can I update the branding on the checkout page?">
  A: Yes. You can:
...
<Accordion title="Q42: Can I embed Dodo Checkout in an iframe?">
...
<Accordion title="Q43: Can I create a one-time hosted checkout payment without adding products to Dodo Payments?">
  A: No. Products are mandatory in the Dodo Payments system.
</Accordion>

<Accordion title="Q44: Can I switch between brands in Dodo Payments?">
...
<Accordion title="Q45: Can I delete a brand or update the Brand URL in Dodo Payments?">
...
<Accordion title="Q46: My INR subscription product is showing USD on checkout. How do I fix that?">
...
<Accordion title="Q47: How do I update my brand URL for secondary brands?">
...
<Accordion title="Q48: Can I change the primary brand in Dodo Payments?">
...
<Accordion title="Q49: How do I collect billing details without passing them in API?">
...
<Accordion title="Q50: What's the difference between static and dynamic payment links?">
...
<Accordion title="Q51: Why does my product price (Rs 100) show a higher amount (Rs 104) during checkout?">
  A: This happens when Adaptive Currency is enabled. The feature adds an additional 4% charge automatically.
</Accordion>

<Accordion title="Q52: What is the $0 payment method?">
...
<Accordion title="Q53: Can I make tax inclusive in the product price?">
...
<Accordion title="Q54: Can addons have their own brand?">
...
<Accordion title="Q55: Can I switch a product to a different brand?">
...
<Accordion title="Q56: What types of payments can I accept with Dodo Payments?">
...
<Accordion title="Q57: How can I track payment statuses?">
...
<Accordion title="Q58: What should I do if a payment fails?">
...
<Accordion title="Q59: Do merchants get notified when a user's payment fails?">
...
<Accordion title="Q66: Why was the first payment marked successful with an amount of $0 for subscription?">
...
<Accordion title="Q67: After the trial period ends, does the customer need to pay (product price(e.g $25)) again manually?">
...
<Accordion title="Q68: What if the trial period shows differently on my app vs. the Dodo Payments dashboard?">
...
<Accordion title="Q69: Do I need to test the trial feature before going live?">
...
<Accordion title="Q70: What happens to a subscription if a payment fails?">
...
<Accordion title="Q71: If I retry payments myself, do I need the failed payment ID?">
  A: No. You only need the subscription ID to initiate a new payment attempt.
</Accordion>

<Accordion title="Q72: How can a subscription payment fail with INCORRECT_NUMBER if previous cycles were successful?">
...
<Accordion title="Q73: Does Dodo support UPI for subscriptions?">
...
<Accordion title="Q74: What does subscription.cancelled_at mean? Is it a scheduled cancellation?">
...
<Accordion title="Q75: When does a subscription get charged?">
...
<Accordion title="Q76: Why does the Change Plan API return an empty response?">
...
<Accordion title="Q77: Why wasn't a new payment prompted when switching from a monthly to an annual plan?">
...
<Accordion title="Q79: How is proration calculated — on the product price or the total amount?">
...
<Accordion title="Q80: Can I advance the next billing date in test mode?">
...
<Accordion title="Q81: How do I add an addon to an existing subscription?">
...
<Accordion title="Q82: How long can a subscription stay in On-Hold state?">
...
<Accordion title="Q83: Does the chargeback apply for business even if my business has a no refund policy?">
...
<Accordion title="Q84: How do I issue a refund?">
...
<Accordion title="Q85: How long does it take for a customer to receive their refund?">
...
<Accordion title="Q86: I'm facing a dispute or chargeback. What can I do?">
...
<Accordion title="Q87: The customer disputed the charge after using the service. Can I appeal this?">
  A: Yes — you can:
...
<Accordion title="Q88: Why is my refund failing with an 'insufficient funds' error?">
...
<Accordion title="Q89: How do payouts work with Dodo Payments?">
...
<Accordion title="Q90: What is the minimum threshold amount after fees and taxes to process payouts?">
  The minimum payout threshold is **\$50 USD** (or **Rs 1,000 INR**). Payouts are triggered when your overall wallet balance exceeds \$50 USD across all currencies.

  **Key points:**
  - You can customize the USD threshold to any amount above \$50 from your dashboard
  - The threshold applies across all currencies combined

  <Tip>
    For detailed information on payout structure and threshold customization, see the [Payout Structure documentation](/features/payouts/payout-structure).
  </Tip>
</Accordion>

<Accordion title="Q91: How do I link my bank account to receive payouts?">
...
<Accordion title="Q92: Can I track the status of my payouts?">
  A: Yes, you can track your payout status from the **Payouts** section of the dashboard.
</Accordion>

<Accordion title="Q93: What are payout fees and how much are they?">
...
<Accordion title="Q94: I received a &quot;payout processed&quot; email — when will the funds arrive?">
...
<Accordion title="Q95: How do I add Payoneer as a payout account?">
...
<Accordion title="Q96: Can I receive payouts to a Payoneer account?">
...
<Accordion title="Q97: My bank info is still in review — what should I do?">
...
<Accordion title="Q98: What happens if my payout day falls on a Friday or weekend?">
...
<Accordion title="Q99: How can I expedite payout compliance if I have an urgent launch or ad campaign planned?">
...
<Accordion title="Q100: I submitted the wrong bank account details. How do I update them?">
...
<Accordion title="Q101: Can I use my personal bank account if I have a registered company?">
  A: No. If you're registered as a company or legal entity, you must use the entity's bank account.
</Accordion>

<Accordion title="Q102: My country doesn't use SWIFT codes. How will that affect my verification?">
...
<Accordion title="Q103: What alternative documentation can I provide if my country doesn't use SWIFT codes?">
...
<Accordion title="Q104: Can I set a payout threshold lower than $50?">
...
<Accordion title="Q105: Do you support daily payouts?">
...
<Accordion title="Q106: How are FX conversion charges calculated?">
...
<Accordion title="Q107: Does Dodo Payments generate invoices automatically?">
...
<Accordion title="Q108: Can I customize the invoices?">
...
<Accordion title="Q109: How do I access or download an invoice?">
...
<Accordion title="Q110: How do I view reports on my transactions and payouts?">
...
<Accordion title="Q111: Why is payment.status sometimes null?">
...
<Accordion title="Q112: Why is product_cart null even though it's a checkout in webhook payload?">
  A:
...
<Accordion title="Q113: My customer completed payment but I didn't receive webhook?">
  A: Checklist:
...
<Accordion title="Q114: Why is my dashboard showing success, but my app didn't update?">
...
<Accordion title="Q115: Will I get two webhook events when someone starts a subscription?">
...
<Accordion title="Q116: Why do we use the `subscription.renewed` webhook for the first subscription?">
...
<Accordion title="Q117: Can I manually verify Dodo Payments webhooks in Python?">
...
<Accordion title="Q118: Where can I find official docs on manual webhook verification?">
...
<Accordion title="Q119: My webhook isn't receiving a POST request, only a GET. Why?">
...
<Accordion title="Q120: Is there a way to manually trigger a webhook event for testing?">
A: You can do it through the webhook dashboard. Go to Dashboard -> Developers -> Webhooks
</Accordion>

<Accordion title="Q121: What's the difference between webhook and redirect URL?">
A:
...
<Accordion title="Q122: Why didn't I receive the product id in the payment.succeeded webhook for a subscription product?">
...
<Accordion title="Q123: How do I verify the webhooks I receive are actually from dodo payments and not from any malicious actors?">
...
<Accordion title="Q124: Why am I receiving a subscription.renew webhook even for the first month payment?">
...
<Accordion title="Q125: How can I test webhooks locally?">
...
<Accordion title="Q126: Why is my webhook not being called after payment?">
...
<Accordion title="Q127: Is it safe to rely on status=success in URL query params?">
...
<Accordion title="Q128: Why are my webhooks always failing?">
  A: Common causes:
...
<Accordion title="Q129: Can I integrate Dodo Payments with Shopify to sell physical products?">
  A: No, Dodo Payments currently does not support physical goods and does not offer a Shopify plugin.
</Accordion>

<Accordion title="Q130: I get a 401 Unauthorized error using the Python SDK. Why?">
...
<Accordion title="Q131: Can I integrate Dodo Payments with my existing website or platform?">
...
<Accordion title="Q132: Is the customer portal tied to a specific customer?">
...
<Accordion title="Q137: Can I integrate Dodo Payments in an Android or mobile app?">
...
<Accordion title="Q138: How do I find my live publishable key (pk_live_...)?">
...
<Accordion title="Q139: Which countries does Dodo Payments accept payments from?">
...
<Accordion title="Q140: Does Dodo Payments support WooCommerce blocks (WordPress block editor)?">
...
<Accordion title="Q141: Why was my real card blocked during testing?">
...
<Accordion title="Q142: Is there a way to test in live mode without making real payments?">
...
<Accordion title="Q143: Can I test subscriptions in Test Mode?">
A: Yes — subscriptions can be tested fully in Test Mode.

Just don't use real card numbers.
</Accordion>

<Accordion title="Q144: How do I switch between Test and Live Mode?">
A:
...
<Accordion title="Q145: Can I use real customer data in Test Mode?">
...
<Accordion title="Q146: I'm seeing a 500 internal_error (&quot;Internal Server Error&quot;) in test mode. How do I fix it?">
...
<Accordion title="Q147: Why am I getting payment_method_unsupported (&quot;mode not enabled for merchant&quot;) in test mode?">
...
<Accordion title="Q148: Why don't I receive emails in Test Mode?">
...
<Accordion title="Q149: Why am I seeing a TRANSACTION_NOT_ALLOWED error during a subscription upgrade/downgrade?">
...
<Accordion title="Q154: What does the requires_customer_action status mean?">
...
<Accordion title="Q155: Why am I getting a SUBSCRIPTION_NOT_ACTIVE error?">
...
<Accordion title="Q156: Why am I getting a payment failure with unknown_error?">
...
<Accordion title="Q157: I'm getting: &quot;You must provide a mandate for off-session card payments&quot;">
  A: It means:
...
<Accordion title="Q158: How does Dodo Payments protect my business from fraud?">
...
<Accordion title="Q159: Is my customer data secure with Dodo Payments?">
...
<Accordion title="Q160: I found a security vulnerability in Dodo Payments. How should I report it?">
A: Please report any discovered vulnerabilities directly to our security team at pt-team@dodopayments.com
</Accordion>

<Accordion title="Q161: Does Dodo Payments offer bug bounties?">
A: We currently do not offer monetary bounties, but we do provide Dodo Payments merchandise as a token of appreciation.
</Accordion>

<Accordion title="Q162: How are customers protected from fraud on Dodo Payments?">
...
<Accordion title="Q163: How do I contact support?">
...
<Accordion title="Q164: My support messages are getting no response. What should I do?">
...
<Accordion title="Q165: How do I unsubscribe a customer from Dodo Digest emails?">
