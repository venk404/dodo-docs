...
## RBI-Compliant Mandates for Indian Payments

Subscriptions using Indian cards (Rupay) and UPI Autopay operate under Reserve Bank of India (RBI) regulations with specific mandate requirements.

<Info>
For complete details on Indian payment methods including one-time payments, see the <a href="/features/payment-methods#upi-and-rupay-india">Payment Methods</a> guide.
</Info>
...
<Warning>
When upgrading or downgrading subscriptions, carefully consider the mandate limits:
...
<Warning>
If you provide benefits, credits, or subscription usage to customers immediately upon charge initiation, you need to handle this 48-hour window appropriately in your application. Consider:
