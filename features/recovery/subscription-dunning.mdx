...
<img src="/images/recovery/dunning-settings.png" alt="Dunning settings page with enable toggle, four on-hold emails at 10, 15, 20, and 25 day intervals, and four cancelled emails at the same intervals" />
</Frame>
...
<Frame caption="Recovery analytics dashboard showing key metrics including dunning performance">
<img src="/images/recovery/acr-analytics.png" alt="Recovery analytics dashboard showing number of abandoned checkouts, recovery rate, recovered revenue total, average time to recover, and breakdowns by product and email" />
</Frame>
...
- **Start with defaults**: The default email timing is designed with reasonable spacing (10, 15, 20, and 25 days) to avoid overwhelming customers while maintaining urgency.
