...
<Frame caption="Dunning analytics dashboard showing success rates and recovered revenue">
<img src="/images/recovery/dunning-analytics.png" alt="Dunning analytics dashboard showing dunning entry counts, success rates, recovered revenue, and per-email performance breakdown" />
</Frame>
