...
- A "Resume Checkout" button to complete the purchase
- Applied discount code (if enabled)

Clicking "Resume Checkout" creates a fresh checkout session with the original cart details. The customer completes payment through the standard checkout flow.
...
<Frame caption="Recovery analytics dashboard showing key metrics and breakdowns">
