...
<Warning>
Only customer-initiated cancellations trigger the cancelled dunning sequence. Merchant-initiated and system cancellations do not trigger dunning.
</Warning>
...
- **Recovery fee ledger entries** — `abandoned_cart_recovery_fee` and `dunning_fees` now appear in the Balance Ledger for transparent fee tracking
- **Recovery analytics dashboard** — New Recovery tab in Analytics showing abandoned checkout counts, recovery rates, recovered revenue, average recovery time, and breakdowns by product and email
